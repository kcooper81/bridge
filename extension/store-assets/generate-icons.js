...
async function main() {
  console.log("Generating extension icons (logo shape only, no background square)...\n");
  ...
  // Also regenerate store-icon-128 with the new style
  const page = await browser.newPage();
  ...
  await page.close();
  console.log("✓ store-icon-128.png (updated)");
