...
export const COMPARISON_PAGES: ComparisonPage[] = [
  {
    ...
    features: [
      ...
      { feature: "Compliance packs", teamPrompt: "20 frameworks", competitor: "Custom policies" },
  ...
  },
  {
    ...
    features: [
      ...
      { feature: "Prompt management", teamPrompt: true, competitor: false },
      { feature: "Compliance packs", teamPrompt: "20 frameworks", competitor: "200+ templates" },
  ...
  },
  {
    ...
    features: [
      ...
      { feature: "Compliance packs", teamPrompt: "20 frameworks", competitor: false },
    ...
    teamPromptStrengths: [
      ...
      "20 compliance frameworks vs zero",
  ...
  },
  {
    ...
    features: [
      ...
      { feature: "Compliance packs", teamPrompt: "20 frameworks", competitor: "Varies" },
    ...
    teamPromptStrengths: [
      ...
      "20 pre-built compliance frameworks",
    ],
    competitorStrengths: [],
    verdict:
  ...
  },
  {
    ...
    intro:
      "Polymer is a SaaS DLP platform that scans data across collaboration tools like Slack, Google Drive, and Microsoft 365 via API integrations. TeamPrompt takes a different approach — a browser extension that scans prompts in real time before they reach AI tools, combined with a shared prompt library and 20 compliance frameworks. Both protect sensitive data, but their threat models are different.",
    features: [
      ...
      { feature: "Free tier", teamPrompt: "Up to 3 users", competitor: false },
      { feature: "Compliance packs", teamPrompt: "20 frameworks", competitor: "Custom rules" },
  ...
  },
  {
    ...
    features: [
      ...
      { feature: "Copilot DLP", teamPrompt: true, competitor: true },
      { feature: "Prompt injection defense", teamPrompt: false, competitor: "Inline blocking" },
      ...
      { feature: "Compliance packs", teamPrompt: "20 frameworks", competitor: "Custom + frameworks" },
  ...
  },
  {
    ...
    features: [
      ...
      { feature: "Compliance frameworks", teamPrompt: "20 packs (HIPAA, SOC 2, GDPR, ...)", competitor: "Custom + 100+" },
  ...
  },
  {
    ...
    features: [
      ...
      { feature: "Compliance frameworks", teamPrompt: "20 packs", competitor: "Custom policies" },
      { feature: "Free tier", teamPrompt: "Up to 3 users", competitor: false },
  ...
  },
  {
    ...
    features: [
      ...
      { feature: "Prompt management library", teamPrompt: true, competitor: false },
      { feature: "Inline prompt-injection blocking", teamPrompt: false, competitor: "Network-level inline" },
      ...
      { feature: "Free tier", teamPrompt: "Up to 3 users", competitor: false },
      { feature: "Self-serve onboarding", teamPrompt: true, competitor: "Enterprise sales" },
      { feature: "Compliance frameworks", teamPrompt: "20 packs", competitor: "Custom policies + frameworks" },
      { feature: "Auto-redaction", teamPrompt: true, competitor: true },
      { feature: "Audit log + SIEM export", teamPrompt: true, competitor: true },
    ],
    teamPromptStrengths: [
  ...
  },
  {
    ...
    features: [
      ...
      { feature: "Prompt management library", teamPrompt: true, competitor: false },
      { feature: "Compliance packs", teamPrompt: "20 frameworks", competitor: "Custom" },
    ...
    teamPromptStrengths: [
      ...
      "20 pre-built compliance frameworks vs custom Lakera rules",
