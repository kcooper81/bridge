...
function ExtensionWelcomeContent() {
  ...
  // Success state — extension auth-bridge will sync the session
  if (authSuccess) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <div className="fixed inset-0 pointer-events-none" style={{ background: "radial-gradient(ellipse at 50% 0%, hsl(var(--primary) / 0.15) 0%, transparent 60%)" }} />
        <div className="relative z-10 w-full max-w-md text-center">
          <div className="rounded-xl border border-border bg-card p-8 shadow-lg">
            ...
            <p className="mt-2 text-muted-foreground">
              Your TeamPrompt extension is now connected. Click the extension icon in your browser toolbar to access your prompts.
            </p>
            <div className="mt-6 space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                You can close this tab and start using the extension on any AI tool.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 w-full max-w-md text-center">
          <div className="rounded-xl border border-border bg-card p-8 shadow-lg">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              We sent a confirmation link to <strong>{email}</strong>. Click the link to activate your account and connect the extension.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="rounded-xl border border-border bg-card p-6 shadow-lg mb-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Sign in to connect your prompt library</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 text-center">
            <div className="rounded-lg bg-muted/50 p-3">
              ...
              <p className="text-xs text-muted-foreground">Insert prompts into any AI tool</p>
            </div>
            <div className="rounded-lg bg-muted/50 p-3">
              <Shield className="h-4 w-4 mx-auto mb-1 text-primary" />
              <p className="text-xs text-muted-foreground">Scan for sensitive data before sending</p>
            </div>
            <div className="rounded-lg bg-muted/50 p-3">
              <MessageSquare className="h-4 w-4 mx-auto mb-1 text-primary" />
              <p className="text-xs text-muted-foreground">Log conversations for compliance</p>
            </div>
          </div>
        </div>
