...
const footerLinks = {
  ...
  Solutions: [
    ...
    { label: "Guides", href: "/solutions#guide" },
    { label: "Comparisons", href: "/solutions#comparison" },
    { label: "Templates", href: "/solutions#template" },
    { label: "Integrations", href: "/solutions#integration" },
  ],
  Industries: [
