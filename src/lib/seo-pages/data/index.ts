...
export const INDEXED_SOLUTION_SLUGS: ReadonlySet<string> = new Set([
  ...
  "what-is-eu-ai-act",
  // Round 2 expansion (2026-06-01) — every page below has unique 700+ word
  // content. Skipped: "prompt-engineering" (OpenAI dominates), "rag" /
  // "embeddings" / "tokens" / "context-window" / "temperature" (Hugging Face,
  // OpenAI, and a thousand tutorials own these), "fine-tuning" (same),
  // "hipaa-ai" / "gdpr-ai" (overlap /compliance/* slugs already indexed).
