...
function setSecurityHeaders(response: NextResponse) {
  ...
  response.headers.set(
    ...
    [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://accounts.google.com https://www.googletagmanager.com https://snap.licdn.com",
      "style-src 'self' 'unsafe-inline'",
      "img-src 'self' data: blob: https: https://px.ads.linkedin.com",
      "font-src 'self' data:",
      "connect-src 'self' https://*.supabase.co https://api.stripe.com wss://*.supabase.co https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com https://images.unsplash.com https://px.ads.linkedin.com https://snap.licdn.com",
