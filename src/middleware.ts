...
function setSecurityHeaders(response: NextResponse) {
  ...
  response.headers.set(
    ...
    [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://accounts.google.com https://www.googletagmanager.com https://googleads.g.doubleclick.net https://www.googleadservices.com https://snap.licdn.com",
      "style-src 'self' 'unsafe-inline'",
      "img-src 'self' data: blob: https: https://px.ads.linkedin.com https://www.google.com https://googleads.g.doubleclick.net",
      "font-src 'self' data:",
      "connect-src 'self' https://*.supabase.co https://api.stripe.com wss://*.supabase.co https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com https://www.google.com https://googleads.g.doubleclick.net https://www.googleadservices.com https://images.unsplash.com https://px.ads.linkedin.com https://snap.licdn.com",
      "frame-src 'self' blob: https://js.stripe.com https://accounts.google.com https://www.googleadservices.com https://googleads.g.doubleclick.net",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
    ].join("; ")
